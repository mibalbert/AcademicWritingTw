...
import { totalAmount } from "./pricing-helper.js";
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const numberOfResourcesMiniValPrice = document.getElementById(
    "numberOfResourcesMiniValPrice"
  );
  const numberOfResourcesMiniValPriceCurr = document.getElementById(
    "numberOfResourcesMiniValPriceCurr"
  );
  ...
  const total = () => {
    ...
    const total = result + numOfPagesSess * 17 + numOfResourcesSess * 17;
    totalDiv.innerHTML = total;
    document.getElementById("totalCurr").innerHTML =
  ...
  const currencySessVal = sessionStorage.getItem("currency");
  const typeServiceSessVal = sessionStorage.getItem("typeService");
  const typePaperSessVal = sessionStorage.getItem("typePaper");
  const numOfPagesSessVal = sessionStorage.getItem("numOfPages");
  const academicLevelSessVal = sessionStorage.getItem("academicLevel");
  const urgencySessVal = sessionStorage.getItem("urgency");
  ...
  const curre = sessionStorage.getItem("currency");

  currencyMiniVal.innerHTML = curre;
  typeServiceMiniVal.innerHTML = typeServiceSessVal;
  typeServiceMiniValPrice.innerHTML = getPriceByName(typeService.value);
  typeServiceMiniValPriceCurr.innerHTML = curre;
  typePaperMiniVal.innerHTML = typePaperSessVal;
  typePaperMiniValPrice.innerHTML = getPriceByName(typePaper.value);
  typePaperMiniValPriceCurr.innerHTML = curre;
  numOfPagesMiniVal.innerHTML = numOfPages.value;
  numOfPagesMiniValPrice.innerHTML = 2;
  numOfPagesMiniValPriceCurr.innerHTML = curre;
  academicLevelMiniVal.innerHTML = academicLevelSessVal;
  academicLevelMiniValPrice.innerHTML = getPriceByName(academicLevelSessVal);
  academicLevelMiniValPriceCurr.innerHTML = curre;
  urgencyMiniVal.innerHTML = urgencySessVal;
  urgencyMiniValPrice.innerHTML = getPriceByName(urgencySessVal);
  urgencyMiniValPriceCurr.innerHTML = curre;
  paperFormatMiniVal.innerHTML = formatSessVal;
  paperFormatMiniValPrice.innerHTML = getPriceByName(formatSessVal);
  paperFormatMiniValPriceCurr.innerHTML = curre;
  subjectAreaMiniVal.innerHTML = subjectAreaSessVal;
  subjectAreaMiniValPrice.innerHTML = getPriceByName(subjectAreaSessVal);
  subjectAreaMiniValPriceCurr.innerHTML = curre;
  numberOfResourcesMiniVal.innerHTML = numOfResouces.value;
  numberOfResourcesMiniValPrice.innerHTML = 2;
  numberOfResourcesMiniValPriceCurr.innerHTML = curre;
  ...
  plus.addEventListener("click", () => {
    ...
    numOfPagesMiniVal.innerHTML = numOfPages.value;
    numOfPagesMiniValPrice.innerHTML = a * 17;
  ...
  minus.addEventListener("click", () => {
    if (a > 1) {
      ...
      let newPrice = Math.max(numOfPagesMiniValPrice.innerHTML - 17, 17);
  ...
  plusR.addEventListener("click", () => {
    ...
    // numberOfResourcesMiniValPrice.innerHTML = a * 2;
    // numberOfResourcesMiniValPriceCurr.innerHTML =
    //   sessionStorage.getItem("currency");
    numberOfResourcesMiniVal.innerHTML = numOfResouces.value;
    numberOfResourcesMiniValPrice.innerHTML = a * 2;
    numberOfResourcesMiniValPriceCurr.innerHTML =
  ...
  minusR.addEventListener("click", () => {
    if (a > 1) {
      ...
      numberOfResourcesMiniVal.innerHTML = a;
      let newPrice = Math.max(numberOfResourcesMiniValPrice.innerHTML - 2, 3);
      numberOfResourcesMiniValPrice.innerHTML = newPrice;
      numberOfResourcesMiniValPriceCurr.innerHTML =
        sessionStorage.getItem("currency");
      total();
    }
...
//     typeServiceMiniValPrice.value = getPriceByName(tps);
//     typeServiceMiniValPriceCurr.innerHTML = sessionStorage.getItem("currency");
//     totalAmounttt += getPriceByName(tps);

//     console.log(totalAmounttt);
//     // total();
//   });
